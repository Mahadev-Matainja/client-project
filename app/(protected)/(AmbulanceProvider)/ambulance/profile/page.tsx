...
const ProfileSettingsPage: React.FC = () => {
  ...
  useEffect(() => {
    const fetchProfileData = async () => {
      try {
        ...
        const response = await api.get("/ambulance/profile/show");
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const response = await api.post("/ambulance/profile/update", formData, {
                ...
                <CardContent className="p-6 text-center">
                  ...
                  <div className="flex justify-center gap-2 mt-3">
                    ...
                    <Badge variant="outline">
                      Provider ID: {personalInfo.provider_id}
                    </Badge>
                  </div>
                </CardContent>
              </Card>
